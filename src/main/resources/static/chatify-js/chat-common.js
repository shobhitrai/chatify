...
function populateChat(chatWindow, userId, profileImage, firstName, lastName, isOnline) {
 const status = isOnline ? 'online' : 'offline';
 const status2 = isOnline ? 'Active' : 'Inactive';
    const context = `
          ...
          <div class="chat">
            <div class="top">
              <div class="container">
                <div class="col-md-12">
                  <div class="inside">
                    <a href="#"><img class="avatar-md" src="${profileImage}" data-toggle="tooltip"
                    data-placement="top" title="${firstName}" alt="avatar"></a>
                  ...
                  <div class="inside">
                    <div class="panel">
                      <div class="participant">
                        <img class="avatar-xxl" src="${profileImage}" alt="avatar">
