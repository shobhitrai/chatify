...
function initializeChatVariables(contact) {
    ...
    chatOpenIsOnline = contact.isOnline;
...
function loadChatMessages(data) {
   ...
   if (chat.length > 0) {
      ...
      `;
        ...
        chatWindow = displayNoChatScreen();
   }
   populateChat(chatWindow, other.userId, other.profileImage, other.firstName, other.lastName, other.isOnline);
}
