function createMainChat(payload) {
   if (payload.status === 100) {
      ...
      data = '<a id="chatgroup-' + sender.userId + '" ' +
...
//      if (chatWindowOpenUserId === sender.userId) {
//         let data = '<div class="babble tab-pane fade" id="chat-' + sender.userId + '">' +
//            '<div class="chat"> <div class="top"> <div class="container"> <div class="col-md-12">' +
//            ' <div class="inside"> <a href="#"><img class="avatar-md" src="' + sender.profileImage + '" ' +
//            'data-toggle="tooltip" data-placement="top" title="' + sender.firstName + '" alt="avatar"></a>' +
//            ' <div class="status"> <i class="material-icons offline">fiber_manual_record</i>' +
//            ' </div> <div class="data"> <h5><a href="#">' + sender.firstName + ' ' + sender.LastName + '</a></h5>' +
...
//            'src="' + sender.profileImage + '" data-toggle="tooltip" data-placement="top" ' +
//            'title="' + sender.firstName + '" alt="avatar"></a> <h5><span>' + chat.message + '</span></h5>' +
//            ' <div class="options"> <button class="btn button fr-accept-btn" id="accept-' + sender.userId + '">' +
//            '<i class="material-icons">check</i></button> <button class="btn button fr-reject-btn" ' +
//            'id="reject-' + sender.userId + '"><i class="material-icons">close</i></button> </div>' +
